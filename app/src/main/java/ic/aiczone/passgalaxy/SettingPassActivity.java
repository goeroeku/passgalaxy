...
/**
 * Created by aic on 30/03/18.
 */

public class SettingPassActivity extends AppCompatActivity
        implements MyPassCallback, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    MyPass myPass;
    Switch switchActive;
